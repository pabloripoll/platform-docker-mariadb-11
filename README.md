...
# INFRASTRUCTURE PLATFORM MARIADB 11.8
...
- **Core Database Platform:** Linux Ubuntu 24.04 + Mariadb 11.8
...
- The database container can start with minimum of 512 megas: `DATABASE_CAAS_MEM=512M` *(CAAS = Container As A Service)*
<br>
